package com.monistoWallet.models
...
import com.monistoWallet.chartview.R
...
class ChartConfig(private val context: Context, attrs: AttributeSet?) {
    ...
    var trendUpColor = context.getColor(R.color.jacob)
    ...
    var trendUpGradient = GradientColor(Color.parseColor("#00FFF0"), Color.parseColor("#00FFF0"))
