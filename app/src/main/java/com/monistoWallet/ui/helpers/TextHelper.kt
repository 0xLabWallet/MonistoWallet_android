...
import com.monistoWallet.core.IClipboardManager
...
object TextHelper : IClipboardManager {
    ...
    override fun copyText(text: String) {
        copyTextToClipboard(com.monistoWallet.core.App.instance, text)
    }
    ...
    fun getQrCodeBitmap(address: String, size: Float = 150F): Bitmap? {
        ...
        return try {
            val imageSize = LayoutHelper.dp(size, com.monistoWallet.core.App.instance)
    ...
    private val clipboard: ClipboardManager?
        get() = com.monistoWallet.core.App.instance.getSystemService(Context.CLIPBOARD_SERVICE) as? ClipboardManager
