    ...
    TopAppBar(
        ...
        navigationIcon = {
            AppBarMenuButton(
                ...
                description = leftButton.title.getString(),
                enabled = leftButton.enabled,
                tint = if (leftButton.tint == Color.Unspecified) ComposeAppTheme.colors.jacob else leftButton.tint
            )
        },
        actions = {
            if (showSpinner) {
            ...
            AppBarMenuButton(
                ...
                description = rightButton.title.getString(),
                enabled = rightButton.enabled,
                tint = if (rightButton.tint == Color.Unspecified) ComposeAppTheme.colors.jacob else rightButton.tint
            )
        },
        elevation = 0.dp
    )
