...
import com.monistoWallet.ui.extensions.BottomSheetSelectorMultiple
...
fun ManageWalletsScreen(
    ...
    val accountType = mainViewModel.accountType ?: run {
        Toast.makeText(com.monistoWallet.core.App.instance, "Error: accountType is NULL", Toast.LENGTH_SHORT).show()
        onBackClick.invoke()
        return
    }
