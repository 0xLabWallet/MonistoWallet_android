...
import com.monistoWallet.core.fiat.AmountTypeSwitchService.AmountType
...
import com.monistoWallet.modules.swap.SwapMainModule.AmountTypeItem
...
import com.monistoWallet.modules.swap.SwapMainModule.ProviderViewItem
import com.monistoWallet.modules.swap.SwapMainModule.SwapActionState
import com.monistoWallet.modules.swap.SwapMainModule.SwapButtons
import com.monistoWallet.modules.swap.SwapMainModule.SwapData
import com.monistoWallet.modules.swap.SwapMainModule.SwapError
...
import com.monistoWallet.modules.swap.allowance.SwapPendingAllowanceState
import com.monistoWallet.modules.swap.oneinch.OneInchKitHelper
import com.monistoWallet.modules.swap.oneinch.OneInchTradeService
import com.monistoWallet.modules.swap.uniswap.IUniswapTradeService
import com.monistoWallet.modules.swap.uniswap.UniswapV2TradeService
import com.monistoWallet.modules.swap.uniswapv3.UniswapV3TradeService
...
class SwapMainViewModel(
    ...
    private fun getTradeService(provider: ISwapProvider): SwapMainModule.ISwapTradeService {
    ...
    private fun getSpenderAddress(provider: ISwapProvider): com.wallet0x.ethereumkit.models.Address {
        val result = when (provider) {
