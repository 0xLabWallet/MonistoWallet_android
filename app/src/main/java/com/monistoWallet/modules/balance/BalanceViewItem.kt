...
class BalanceViewItemFactory {
    ...
    private fun lockedCoinValue(
        ...
        val value = com.monistoWallet.core.App.numberFormatter.formatCoinFull(balance, token.coin.code, coinDecimals)
    ...
    private fun lockedCoinValue(
        ...
        val visible = !hideBalance
        val value = com.monistoWallet.core.App.numberFormatter.formatCoinFull(balance, coinCode, coinDecimals)
