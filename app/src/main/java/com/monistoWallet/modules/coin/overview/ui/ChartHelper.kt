...
import com.monistoWallet.CurveAnimator2
import com.monistoWallet.CurveAnimatorBars
import com.monistoWallet.models.ChartIndicator
import java.math.BigDecimal
import kotlin.math.abs
import kotlin.math.absoluteValue

class ChartHelper(private var target: ChartData, var hasVolumes: Boolean, private val colors: com.monistoWallet.ui.compose.Colors) {
    ...
    var mainCurveColor = colors.jacob
    var mainCurveGradientColors = Pair(Color(0x0000FFF0), Color(0x0066fff5))
    ...
    private fun defineColors() {
        ...
        when {
            ...
            chartData.diff() < BigDecimal.ZERO -> {
                ...
                mainCurveColor = colors.jacob
                mainCurveGradientColors = Pair(Color(0x00416BFF), Color(0xFF00FFF0))
            }
        }
    }
