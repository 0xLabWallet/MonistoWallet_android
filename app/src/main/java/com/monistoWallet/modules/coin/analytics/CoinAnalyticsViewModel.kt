package com.monistoWallet.modules.coin.analytics
...
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.ActionType
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticChart
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticInfo
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.AnalyticsViewItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BlockViewItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.IconTitle
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.OverallScoreValue
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Title
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.TitleWithInfo
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.BoxItem.Value
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.ChartViewItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.FooterItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.PreviewBlockViewItem
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.PreviewChartType
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.RankType
import com.monistoWallet.modules.coin.analytics.CoinAnalyticsModule.ScoreCategory
import com.monistoWallet.modules.coin.technicalindicators.CoinIndicatorViewItemFactory
import com.monistoWallet.modules.coin.technicalindicators.TechnicalIndicatorData
import com.monistoWallet.modules.coin.technicalindicators.TechnicalIndicatorService
import com.monistoWallet.modules.coin.technicalindicators.TechnicalIndicatorService.SectionItem
import com.monistoWallet.modules.market.ImageSource
import com.monistoWallet.modules.metricchart.ProChartModule
import com.monistoWallet.ui.compose.TranslatableString
import com.monistoWallet.ui.compose.TranslatableString.ResString
import com.monistoWallet.ui.compose.components.StackBarSlice
import com.monistoWallet.ChartViewType
import com.wallet0x.marketkit.models.Analytics
import com.wallet0x.marketkit.models.AnalyticsPreview
import com.wallet0x.marketkit.models.ChartPoint
...
class CoinAnalyticsViewModel(
            ...
            data.sortedByDescending { it.holdersCount }.forEach { item ->
                ...
                blockchain?.let {
                    ...
                    footerItems.add(
                        FooterItem(
                            title = IconTitle(
                                com.monistoWallet.modules.market.ImageSource.Remote(blockchain.type.imageUrl, R.drawable.coin_placeholder),
        ...
        if (analyticsPreview.holders) {
            ...
            footerItems.addAll(
                listOf(
                    FooterItem(
                        title = IconTitle(
                            com.monistoWallet.modules.market.ImageSource.Local(R.drawable.ic_platform_placeholder_24),
    ...
    private fun getChartViewItem(
        ...
        val points = values.map {
            com.monistoWallet.models.ChartPoint(it.value.toFloat(), it.timestamp)
        }
