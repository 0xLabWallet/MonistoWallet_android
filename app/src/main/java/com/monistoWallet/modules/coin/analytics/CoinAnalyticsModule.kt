...
object CoinAnalyticsModule {
    ...
    class Factory(private val fullCoin: FullCoin, private val apiTag: String) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            val service = CoinAnalyticsService(
                ...
                com.monistoWallet.core.App.subscriptionManager,
    ...
    sealed class BoxItem {
        ...
        class IconTitle(val image: com.monistoWallet.modules.market.ImageSource, val text: TranslatableString) : BoxItem()
    ...
    enum class RankType(val title: Int, val description: Int, val headerIconName: String) : Parcelable {
        ...
        val headerIcon: com.monistoWallet.modules.market.ImageSource
            get() = com.monistoWallet.modules.market.ImageSource.Remote("https://cdn.blocksdecoded.com/header-images/$headerIconName@3x.png")
    }
