        ...
        hint = if (tmpRate == null) {
            ...
            when (inputType) {
                AmountInputType.COIN -> {
                    com.monistoWallet.core.App.numberFormatter.format(currencyAmount ?: BigDecimal.ZERO, fiatDecimal, fiatDecimal, prefix = tmpRate.currency.symbol)
                }
                AmountInputType.CURRENCY -> {
                    com.monistoWallet.core.App.numberFormatter.formatCoinFull(coinAmount ?: BigDecimal.ZERO, coinCode, coinDecimal)
                }
            }
        }
    }
