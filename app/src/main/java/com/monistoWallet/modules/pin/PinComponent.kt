...
import com.monistoWallet.modules.pin.core.LockManager
import com.monistoWallet.modules.pin.core.PinDbStorage
import com.monistoWallet.modules.pin.core.PinManager
...
class PinComponent(
    ...
    private val appLockManager: LockManager by lazy {
        LockManager(pinManager, com.monistoWallet.core.App.localStorage)
    }
