...
import com.monistoWallet.ui.compose.components.headline2_jacob
...
private fun formatUsd(number: Int): String {
    ...
    return com.monistoWallet.core.App.numberFormatter.formatFiatShort(BigDecimal(number), symbol, decimals)
}

private fun formatNumber(number: Int): String {
    return com.monistoWallet.core.App.numberFormatter.formatNumberShort(BigDecimal(number), 2)
}
