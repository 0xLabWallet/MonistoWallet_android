package com.monistoWallet.modules.backuplocal.fullbackup
...
import com.monistoWallet.core.managers.EncryptDecryptManager
...
import com.monistoWallet.modules.backuplocal.BackupLocalModule
...
class BackupProvider(
    ...
    private suspend fun restoreSettings(settings: Settings, passphrase: String) {
        ...
        localStorage.cardsTabEnabled = settings.cardsTabEnabled
        localStorage.cryptoWalletTabEnabled = settings.cryptoWalletTabEnabled
    ...
    fun createFullBackup(accountIds: List<String>, passphrase: String): String {
        ...
        val settings = Settings(
            ...
            cardsTabEnabled = localStorage.cardsTabEnabled,
            cryptoWalletTabEnabled = localStorage.cryptoWalletTabEnabled,
...
data class Settings(
    ...
    @SerializedName("show_cards_tab")
    val cardsTabEnabled: Boolean,
    @SerializedName("show_crypto_wallet_tab")
