...
import com.monistoWallet.core.PasswordError
...
class BackupLocalPasswordViewModel(
    ...
    var backupFileName: String = "Dexnet_Backup.json"
        private set
        ...
        when (type) {
            is BackupType.SingleWalletBackup -> {
                ...
                if (account == null) {
                    ...
                    backupFileName = "Dexnet_Backup_$walletName.json"
                }
            }

            is BackupType.FullBackup -> {
                backupFileName = "Dexnet_App_Backup.json"
            }
        }
