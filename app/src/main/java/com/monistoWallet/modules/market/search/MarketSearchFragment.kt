...
import com.monistoWallet.modules.market.search.MarketSearchModule.CoinItem
...
import com.monistoWallet.ui.compose.components.HeaderStick
...
private fun MarketCoin(
    ...
    fun fetchoinIconUrl(coinCode: String): String {
        if (coinCode != "DEXNET") {
            return coinIconUrl
        } else {
    ...
    SectionItemBorderedRowUniversalClear(
        ...
        CoinImage(
            iconUrl = fetchoinIconUrl(coinCode),
