...
import com.monistoWallet.modules.market.search.MarketSearchModule
    ...
    companion object {
        ...
        fun getCategoryMarketData(
            ...
            val marketCap = coinCategory.marketCap?.let { marketCap ->
                com.monistoWallet.core.App.numberFormatter.formatFiatShort(marketCap, baseCurrency.symbol, 2)
            }
