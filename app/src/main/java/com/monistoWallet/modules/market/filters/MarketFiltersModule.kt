...
object MarketFiltersModule {
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            val service = MarketFiltersService(com.monistoWallet.core.App.marketKit, com.monistoWallet.core.App.currencyManager.baseCurrency)
...
interface IMarketListFetcher {
    fun fetchAsync(): Single<List<com.monistoWallet.modules.market.MarketItem>>
}