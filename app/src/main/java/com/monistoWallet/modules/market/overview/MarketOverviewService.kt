...
class MarketOverviewService(
    ...
    val topMarketOptions: List<com.monistoWallet.modules.market.TopMarket> = com.monistoWallet.modules.market.TopMarket.values().toList()
    val timeDurationOptions: List<com.monistoWallet.modules.market.TimeDuration> = listOf(
