...
import com.monistoWallet.entities.transactionrecords.bitcoin.BitcoinTransactionRecord
import com.monistoWallet.entities.transactionrecords.bitcoin.TransactionLockState
...
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Address
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Amount
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.ContactItem
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.DoubleSpend
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Explorer
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.LockState
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.NftAmount
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.RawTransaction
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.SentToSelf
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.SpeedUpCancel
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Status
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Transaction
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.TransactionHash
import com.monistoWallet.modules.transactionInfo.TransactionInfoViewItem.Value
...
class TransactionInfoViewItemFactory(
    ...
    private fun getSendSectionItems(
        ...
        val items: MutableList<TransactionInfoViewItem> = mutableListOf(
            Transaction(title, subtitle, if (burn) R.drawable.icon_24_flame else R.drawable.ic_arrow_down_left_12),
            amount
        )
    ...
    private fun getSwapEventSectionItems(
        ...
        listOf(
            Transaction(
                title,
                value.fullName,
                icon = if (incoming) R.drawable.ic_arrow_down_left_12_old else R.drawable.ic_arrow_up_right_12
            ),
