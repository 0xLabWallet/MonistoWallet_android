...
class EvmTransactionsAdapter(
    ...
    private val evmTransactionSource: com.wallet0x.ethereumkit.models.TransactionSource,
    evmLabelManager: EvmLabelManager
) : ITransactionsAdapter {

    private val evmKit = evmKitWrapper.evmKit
    private val transactionConverter = EvmTransactionConverter(coinManager, evmKitWrapper, source, com.monistoWallet.core.App.spamManager, baseToken, evmLabelManager)
