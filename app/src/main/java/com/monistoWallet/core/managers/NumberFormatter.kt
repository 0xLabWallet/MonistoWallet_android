...
class NumberFormatter(
    ...
    override fun formatValueAsDiff(value: com.monistoWallet.modules.market.Value): String =
        when (value) {
            is com.monistoWallet.modules.market.Value.Currency -> {
            ...
            is com.monistoWallet.modules.market.Value.Percent -> {
