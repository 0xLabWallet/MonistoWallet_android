...
import com.wallet0x.erc20kit.core.DataProvider
import com.wallet0x.erc20kit.events.TransferEventInstance
import com.wallet0x.ethereumkit.core.EthereumKit
import com.wallet0x.ethereumkit.decorations.IncomingDecoration
import com.wallet0x.ethereumkit.decorations.UnknownTransactionDecoration
...
import com.wallet0x.oneinchkit.decorations.OneInchDecoration
import com.wallet0x.oneinchkit.decorations.OneInchSwapDecoration
import com.wallet0x.oneinchkit.decorations.OneInchUnknownDecoration
import com.wallet0x.oneinchkit.decorations.OneInchUnoswapDecoration
...
class EvmAccountManager(
    ...
    private fun handle(fullTransactions: List<FullTransaction>, account: com.monistoWallet.entities.Account, evmKitWrapper: EvmKitWrapper, initial: Boolean) {
    ...
    private suspend fun handle(tokenInfos: List<TokenInfo>, account: com.monistoWallet.entities.Account, evmKit: EthereumKit) = withContext(Dispatchers.IO) {
...
//        Log.e("AAA", "New Tokens: ${newTokenInfos.size}")
    ...
    data class FoundToken(
        ...
        val tokenInfo: com.wallet0x.erc20kit.events.TokenInfo? = null
    ) {
