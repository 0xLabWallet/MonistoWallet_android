...
import com.monistoWallet.modules.balance.cex.CexAddress
...
class CexProviderManager(private val accountManager: IAccountManager) {
    ...
    private fun handleAccount(account: com.monistoWallet.entities.Account?) {
        val cexProvider = when (val cexType = (account?.type as? com.monistoWallet.entities.AccountType.Cex)?.cexType) {
            is com.monistoWallet.entities.CexType.Binance -> BinanceCexProvider(cexType.apiKey, cexType.secretKey, account)
            null -> null
        }
...
interface ICexProvider {
    val account: com.monistoWallet.entities.Account
...
class BinanceCexProvider(apiKey: String, secretKey: String, override val account: com.monistoWallet.entities.Account) : ICexProvider {
