...
import com.monistoWallet.entities.BitcoinCashCoinType
import com.monistoWallet.entities.FeePriceScale
import com.wallet0x.bitcoincash.MainNetBitcoinCash
import com.wallet0x.hdwalletkit.ExtendedKeyCoinType
...
val Blockchain.description: String
    get() = when (type) {
        ...
        BlockchainType.Dexnet -> "DNC, DEX20 tokens"
...
val BlockchainType.imageUrl: String
    get() = if (uid == "dexnet") "https://bridge.dexnetchain.com/api/image/dex_squared@3x.png" else "https://cdn.blocksdecoded.com/blockchain-icons/32px/$uid@3x.png"
...
val BlockchainType.tokenIconPlaceholder: Int
    get() = when (this) {
        ...
        BlockchainType.Dexnet -> R.drawable.logo_dex20_chain_coins
...
val BlockchainType.brandColor: Color?
    get() = when (this) {
        ...
        BlockchainType.Dexnet -> Color(0x0000FFF0)
...
val Coin.imageUrl: String
    get() {
        this.name
        if (this.name == "DexNet" || this.name == "Dexnet Coin") {
            return "https://bridge.dexnetchain.com/api/image/dex@3x.png"
        } else if (uid.contains("custom-dexnet")) {
            return "https://raw.githubusercontent.com/DexSAFE/Design/main/logo_dex20_chain_coins.png"
        }
